...
#ifndef AANDUSB_YUV420SP_NV12_EXT_YUV_TARGET_FSH_H
#define AANDUSB_YUV420SP_NV12_EXT_YUV_TARGET_FSH_H
...
void main() {
	vec3 srcYuv = texture(sTexture, vTextureCoord).xzy;
...
#endif //AANDUSB_YUV420SP_NV12_EXT_YUV_TARGET_FSH_H
