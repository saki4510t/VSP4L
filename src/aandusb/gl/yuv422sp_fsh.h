...
#ifndef AANDUSB_YUV422sp_FSH_H
#define AANDUSB_YUV422sp_FSH_H

// yuv422spの3プレーンのデータをGL_LUMINANCEの1つのテクスチャとして渡して
// RGBAとして描画するためのフラグメントシェーダー
#if __ANDROID__ || defined(ENABLE_GLES)
constexpr const char *yuv422sp_as_lumi_gl2_fsh =
...
// YUV422spのセミプレーンのデータをYとUVの2枚のテクスチャに分けて渡して換算する場合(元の1ピクセル分のデータがテクセル1個に対応)
void main() {
...
constexpr const char *yuv422sp_as_lumi_gl3_fsh =
